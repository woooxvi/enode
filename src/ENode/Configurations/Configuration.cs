...
namespace ENode.Configurations
{
    ...
    public class ENodeConfiguration
    {
        ...
        public ENodeConfiguration RegisterENodeComponents()
        {
            ...
            _configuration.SetDefault<ActivitySource, ActivitySource>(new ActivitySource("default-enode-activity-source"));
            _configuration.SetDefault<IErrorStore, DefAultErrorStore>();
