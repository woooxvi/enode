...
namespace ENode.EQueue
{
    public class CommandService : ICommandService
    {
        ...
        private EQueueMessage BuildCommandMessage(ICommand command, out string messageBody, bool needReply = false)
        {
            ...
            var replyAddress = needReply && _commandResultProcessor != null ? _commandResultProcessor.ReplyAddress?.ToString() ?? _commandResultProcessor.BindingAddress.ToString() : null;
